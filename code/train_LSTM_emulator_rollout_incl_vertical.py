...
# This is a modification of the train_LSTM_emulator_rollout.py code such that it includes MLD as input and predicts also vertically averaged values of phytoplankton and zooplankton variables, as well as sea bottom oxygen. 
...
# Dense layers
    ...
    with open("history_model_LSTM_vert_"+str(ens)+".json", "w") as f:
        json.dump(history.history, f)


    model.save("best_model_LSTM_vert_"+str(ens)+".keras")  # save the best weights
